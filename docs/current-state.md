...
_Last updated: 2026-07-10 (R4.5 Wave 1.2 merged — ghost/actor depth interleave, #69)._
...
- **Branches**: `main` = R3 block (PR #63). `develop` = R4.5 Wave 1.2.
- **Suite**: 2461 tests green, tsc/eslint clean. Patch notes current: 2026-07-10e (R3 presence).
