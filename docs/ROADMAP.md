...
- [ ] Lockstep party P4-P6: VPS ws relay (โง่: จัดห้อง+fan-out) + client turnLoop wiring + render 3 ฮีโร่/ร่างเงาจาง/ป้ายออฟไลน์ + exp buff ใน cohort (sim จูน) — **รอผล ws-probe จากเจ้าของ**
