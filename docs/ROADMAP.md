...
## 🎨 M6.5b — UI Skin (ปลุกขึ้นมา 2026-07-06)

> หยิบของแขวนจาก M6.5 กลับมา — แนวทาง **"ชิมก่อนเหมา"** ลดเสี่ยงรสนิยม (M6.5 เคยปิดเพราะเจ้าของไม่ชอบ art ที่ลอง): wave 1 ทำแค่ design tokens + ฟอนต์ไทย + หน้า title ให้เจ้าของเคาะก่อน แล้วค่อย roll out · **responsive desktop + mobile ตั้งแต่ต้น** · ไอคอน = emoji ก่อนปี 2020 หรือ CSS-drawn (Windows 10 footgun) · ทำคู่ขนานกับ M7.6 ได้ (ไฟล์ไม่ชน) ยกเว้นช่วง M7.6 UI wave

- [ ] Wave 1: design tokens (สี/กรอบ/กระดุม ตาม art direction ฉากหม่น-ตัวละครอัญมณี) + คู่ฟอนต์ไทย (`next/font`) + หน้า title → **รอเจ้าของเคาะ**
- [ ] Wave 2 (หลังเคาะ): หน้าเลือกตัวละคร + HUD กรอบเกม
