...
- [ ] **ค้าง**: เจ้าของเล่นจริง — เดินไปประตูแล้วค่อยข้าม feel · บอทปิด default (**ต้องหลัง deploy เท่านั้นถึงเห็นบน prod**) · แผงใหม่ทุกบานบนมือถือ (doll strip / RefinePanel / Bot panel) · ตำแหน่ง AUTO ใหม่ · จอใหญ่ desktop + การ์ดเควสซ้อน (ชน BuffBadgeHub ไหม) — merge เข้า main เมื่อเจ้าของยืนยัน
